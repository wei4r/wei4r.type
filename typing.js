...
document.getElementById('game').addEventListener('keydown', ev => {
  ...
  if (!currentLetter.nextSibling){
    if (document.querySelector(".word-box.current").children[1].getElementsByClassName('incorrect').length === 0){
