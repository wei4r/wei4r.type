...
function newGame() {
  ...
  document.getElementById('enter-to-skip').style.display = 'flex';
...
function gameOver() {
  ...
  document.getElementById('enter-to-skip').style.display = 'none';
